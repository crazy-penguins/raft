...
class Collection_:
    class init:
        ...
        def accepts_auto_dash_names_kwarg(self):
            ...
            assert Collection(auto_dash_names=True).auto_dash_names is True
    ...
    class from_module:
        ...
        class parameters:
            ...
            def auto_dash_names_passed_to_constructor(self):
                # Sanity
                assert self.from_module(self.mod).auto_dash_names is False
                # Test
                coll = self.from_module(self.mod, auto_dash_names=True)
                assert coll.auto_dash_names is True
